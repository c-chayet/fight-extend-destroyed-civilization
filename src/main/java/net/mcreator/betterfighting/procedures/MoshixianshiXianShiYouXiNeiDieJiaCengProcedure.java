...
public class MoshixianshiXianShiYouXiNeiDieJiaCengProcedure {
	...
	public static boolean executeProcedure(Map<String, Object> dependencies) {
		if (dependencies.get("entity") == null) {
			if (!dependencies.containsKey("entity"))
				FightExtendDcMod.LOGGER.warn("Failed to load dependency entity for procedure MoshixianshiXianShiYouXiNeiDieJiaCeng!");
			return false;
		}
		...
		if (((entity instanceof LivingEntity) ? ((LivingEntity) entity).getHeldItemMainhand() : ItemStack.EMPTY)
			...
			if (((entity instanceof LivingEntity) ? ((LivingEntity) entity).getHeldItemMainhand() : ItemStack.EMPTY).getOrCreateTag()
					.getDouble("DMode") == 0) {
				entity.getPersistentData().putString("mode", "NORMAL");
			} else {
				entity.getPersistentData().putString("mode", "KILLER");
			}
			return true;
		}
		return false;
