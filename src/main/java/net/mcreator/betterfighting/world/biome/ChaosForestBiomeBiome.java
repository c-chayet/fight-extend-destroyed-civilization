...
public class ChaosForestBiomeBiome extends FightExtendDcModElements.ModElement {
	public static Biome biome;

	public ChaosForestBiomeBiome(FightExtendDcModElements instance) {
		super(instance, 152);
		...
		public void registerBiomes(RegistryEvent.Register<Biome> event) {
			if (biome == null) {
				BiomeAmbience effects = new BiomeAmbience.Builder().setFogColor(-3355444).setWaterColor(4159204).setWaterFogColor(329011)
						.withSkyColor(-3355444).withFoliageColor(10387789).withGrassColor(-13382656).build();
				...
				biomeGenerationSettings.withFeature(GenerationStage.Decoration.VEGETAL_DECORATION, Feature.TREE
						.withConfiguration((new BaseTreeFeatureConfig.Builder(new SimpleBlockStateProvider(ChaosLogBlock.block.getDefaultState()),
								new SimpleBlockStateProvider(ChaosLeavesBlock.block.getDefaultState()),
				...
				event.getRegistry().register(biome.setRegistryName("fight_extend_dc:chaos_forest_biome"));
			}
		}
	}
	...
	private static class CustomLeaveVineTreeDecorator extends LeaveVineTreeDecorator {
		...
		static {
			...
			tdt.setRegistryName("chaos_forest_biome_lvtd");
	...
	private static class CustomTrunkVineTreeDecorator extends TrunkVineTreeDecorator {
		...
		static {
			codec = com.mojang.serialization.Codec.unit(() -> instance);
			tdt = new TreeDecoratorType(codec);
			tdt.setRegistryName("chaos_forest_biome_tvtd");
			ForgeRegistries.TREE_DECORATOR_TYPES.register(tdt);
		}
	...
	private static class CustomCocoaTreeDecorator extends CocoaTreeDecorator {
		...
		static {
			codec = com.mojang.serialization.Codec.unit(() -> instance);
			tdt = new TreeDecoratorType(codec);
			tdt.setRegistryName("chaos_forest_biome_ctd");
			ForgeRegistries.TREE_DECORATOR_TYPES.register(tdt);
		}
