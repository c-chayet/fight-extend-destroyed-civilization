...
import net.mcreator.betterfighting.procedures.StreukyDangShiTiSiWangShiProcedure;
import net.mcreator.betterfighting.item.MagicalCrystalScytheItem;
import net.mcreator.betterfighting.entity.renderer.StreukyRenderer;
...
public class StreukyEntity extends BetterFightingModElements.ModElement {
	public static EntityType entity = (EntityType.Builder.<CustomEntity>create(CustomEntity::new, EntityClassification.MONSTER)
			...
			.size(0.6f, 1.8f)).build("streuky").setRegistryName("streuky");

	public StreukyEntity(BetterFightingModElements instance) {
		super(instance, 28);
		FMLJavaModLoadingContext.get().getModEventBus().register(new StreukyRenderer.ModelRegisterHandler());
	...
	public static class CustomEntity extends ZombieEntity {
		...
		public CustomEntity(EntityType<CustomEntity> type, World world) {
			...
			setNoAI(false);
			enablePersistence();
			this.setItemStackToSlot(EquipmentSlotType.MAINHAND, new ItemStack(MagicalCrystalScytheItem.block));
		...
		public void onDeath(DamageSource source) {
			...
			StreukyDangShiTiSiWangShiProcedure.executeProcedure(Stream
