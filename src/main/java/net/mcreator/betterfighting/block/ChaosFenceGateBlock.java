...
public class ChaosFenceGateBlock extends BetterFightingModElements.ModElement {
	@ObjectHolder("better_fighting:chaos_fence_gate")
	public static final Block block = null;

	public ChaosFenceGateBlock(BetterFightingModElements instance) {
		super(instance, 139);
	}
	...
	public static class CustomBlock extends FenceGateBlock {
		public CustomBlock() {
			...
			setRegistryName("chaos_fence_gate");
		}
