...
public class ChaosPressurePlateBlock extends BetterFightingModElements.ModElement {
	@ObjectHolder("better_fighting:chaos_pressure_plate")
	public static final Block block = null;

	public ChaosPressurePlateBlock(BetterFightingModElements instance) {
		super(instance, 140);
	}
	...
	public static class CustomBlock extends PressurePlateBlock {
		public CustomBlock() {
			...
			setRegistryName("chaos_pressure_plate");
		}
