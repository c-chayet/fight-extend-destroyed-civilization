...
public class ChaosLogBlock extends BetterFightingModElements.ModElement {
	@ObjectHolder("better_fighting:chaos_log")
	public static final Block block = null;

	public ChaosLogBlock(BetterFightingModElements instance) {
		super(instance, 133);
	}
