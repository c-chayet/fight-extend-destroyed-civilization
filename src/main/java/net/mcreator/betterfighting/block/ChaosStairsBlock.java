...
public class ChaosStairsBlock extends BetterFightingModElements.ModElement {
	@ObjectHolder("better_fighting:chaos_stairs")
	public static final Block block = null;

	public ChaosStairsBlock(BetterFightingModElements instance) {
		super(instance, 136);
	}
