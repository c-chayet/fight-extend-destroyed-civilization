...
public class ChaosButtonBlock extends BetterFightingModElements.ModElement {
	@ObjectHolder("better_fighting:chaos_button")
	public static final Block block = null;

	public ChaosButtonBlock(BetterFightingModElements instance) {
		super(instance, 141);
	}
