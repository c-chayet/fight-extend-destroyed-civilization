...
public class LightingChaosStoneBlock extends BetterFightingModElements.ModElement {
	@ObjectHolder("better_fighting:lighting_chaos_stone")
	public static final Block block = null;

	public LightingChaosStoneBlock(BetterFightingModElements instance) {
		super(instance, 174);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("lighting_chaos_stone");
		}
