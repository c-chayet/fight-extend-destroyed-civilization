...
public class ChaosWoodBlock extends BetterFightingModElements.ModElement {
	@ObjectHolder("better_fighting:chaos_wood")
	public static final Block block = null;

	public ChaosWoodBlock(BetterFightingModElements instance) {
		super(instance, 132);
	}
