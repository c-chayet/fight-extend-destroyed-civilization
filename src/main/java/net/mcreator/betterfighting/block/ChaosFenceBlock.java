...
public class ChaosFenceBlock extends BetterFightingModElements.ModElement {
	@ObjectHolder("better_fighting:chaos_fence")
	public static final Block block = null;

	public ChaosFenceBlock(BetterFightingModElements instance) {
		super(instance, 138);
	}
