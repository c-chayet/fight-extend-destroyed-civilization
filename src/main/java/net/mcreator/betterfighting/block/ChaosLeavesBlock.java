...
import net.mcreator.betterfighting.procedures.ChaosLeavesDangFangKuaiBeiWanJiaPoPiShiProcedure;
...
public class ChaosLeavesBlock extends BetterFightingModElements.ModElement {
	@ObjectHolder("better_fighting:chaos_leaves")
	public static final Block block = null;

	public ChaosLeavesBlock(BetterFightingModElements instance) {
		super(instance, 135);
	}
	...
	public static class CustomBlock extends Block {
		...
		public boolean removedByPlayer(BlockState blockstate, World world, BlockPos pos, PlayerEntity entity, boolean willHarvest, FluidState fluid) {
			...
			ChaosLeavesDangFangKuaiBeiWanJiaPoPiShiProcedure.executeProcedure(Stream
