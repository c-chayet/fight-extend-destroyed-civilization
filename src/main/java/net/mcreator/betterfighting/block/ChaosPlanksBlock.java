...
public class ChaosPlanksBlock extends BetterFightingModElements.ModElement {
	@ObjectHolder("better_fighting:chaos_planks")
	public static final Block block = null;

	public ChaosPlanksBlock(BetterFightingModElements instance) {
		super(instance, 134);
	}
