...
public class WoodenScytheItem extends BetterFightingModElements.ModElement {
	@ObjectHolder("better_fighting:wooden_scythe")
	public static final Item block = null;

	public WoodenScytheItem(BetterFightingModElements instance) {
		super(instance, 40);
	}
