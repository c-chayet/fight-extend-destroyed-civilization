...
public class IronKnifeItem extends BetterFightingModElements.ModElement {
	@ObjectHolder("better_fighting:iron_knife")
	public static final Item block = null;
	public IronKnifeItem(BetterFightingModElements instance) {
		super(instance, 3);
	}
