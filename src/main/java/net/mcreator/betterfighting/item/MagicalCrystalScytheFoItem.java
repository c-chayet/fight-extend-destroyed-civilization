...
public class MagicalCrystalScytheFoItem extends BetterFightingModElements.ModElement {
	@ObjectHolder("better_fighting:magical_crystal_scythe_fo")
	public static final Item block = null;

	public MagicalCrystalScytheFoItem(BetterFightingModElements instance) {
		super(instance, 48);
	}
	...
	public void initElements() {
		elements.items.add(() -> new ItemToolCustom() {
			...
			public void addInformation(ItemStack itemstack, World world, List<ITextComponent> list, ITooltipFlag flag) {
				...
				list.add(new StringTextComponent("\u00A75Refinement Level 3"));
			}
		...
		}.setRegistryName("magical_crystal_scythe_fo"));
	}
