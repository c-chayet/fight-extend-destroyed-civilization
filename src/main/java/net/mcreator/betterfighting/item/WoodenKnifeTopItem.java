...
public class WoodenKnifeTopItem extends BetterFightingModElements.ModElement {
	@ObjectHolder("better_fighting:wooden_knife_top")
	public static final Item block = null;

	public WoodenKnifeTopItem(BetterFightingModElements instance) {
		super(instance, 16);
	}
	...
	public static class ItemCustom extends Item {
		public ItemCustom() {
			...
			setRegistryName("wooden_knife_top");
		}
