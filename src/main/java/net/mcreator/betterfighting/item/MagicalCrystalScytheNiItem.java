...
public class MagicalCrystalScytheNiItem extends BetterFightingModElements.ModElement {
	@ObjectHolder("better_fighting:magical_crystal_scythe_ni")
	public static final Item block = null;

	public MagicalCrystalScytheNiItem(BetterFightingModElements instance) {
		super(instance, 53);
	}
	...
	public void initElements() {
		...
		}.setRegistryName("magical_crystal_scythe_ni"));
	}
		...
		public Multimap<Attribute, AttributeModifier> getAttributeModifiers(EquipmentSlotType equipmentSlot) {
			if (equipmentSlot == EquipmentSlotType.MAINHAND) {
				...
				builder.put(Attributes.ATTACK_DAMAGE,
						new AttributeModifier(ATTACK_DAMAGE_MODIFIER, "Tool modifier", 32f, AttributeModifier.Operation.ADDITION));
