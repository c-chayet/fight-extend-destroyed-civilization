...
public class IronScytheItem extends BetterFightingModElements.ModElement {
	@ObjectHolder("better_fighting:iron_scythe")
	public static final Item block = null;

	public IronScytheItem(BetterFightingModElements instance) {
		super(instance, 42);
	}
