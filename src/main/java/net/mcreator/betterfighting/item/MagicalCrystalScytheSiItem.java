...
public class MagicalCrystalScytheSiItem extends BetterFightingModElements.ModElement {
	@ObjectHolder("better_fighting:magical_crystal_scythe_si")
	public static final Item block = null;

	public MagicalCrystalScytheSiItem(BetterFightingModElements instance) {
		super(instance, 50);
	}
	...
	public void initElements() {
		elements.items.add(() -> new ItemToolCustom() {
			...
			public void addInformation(ItemStack itemstack, World world, List<ITextComponent> list, ITooltipFlag flag) {
				...
				list.add(new StringTextComponent("\u00A75Refinement Level 5[max]"));
			}
		...
		}.setRegistryName("magical_crystal_scythe_si"));
	}
		...
		public Multimap<Attribute, AttributeModifier> getAttributeModifiers(EquipmentSlotType equipmentSlot) {
			if (equipmentSlot == EquipmentSlotType.MAINHAND) {
				...
				builder.put(Attributes.ATTACK_DAMAGE,
						new AttributeModifier(ATTACK_DAMAGE_MODIFIER, "Tool modifier", 23f, AttributeModifier.Operation.ADDITION));
