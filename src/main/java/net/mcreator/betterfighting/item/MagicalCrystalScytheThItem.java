...
public class MagicalCrystalScytheThItem extends BetterFightingModElements.ModElement {
	@ObjectHolder("better_fighting:magical_crystal_scythe_th")
	public static final Item block = null;

	public MagicalCrystalScytheThItem(BetterFightingModElements instance) {
		super(instance, 47);
	}
	...
	public void initElements() {
		elements.items.add(() -> new ItemToolCustom() {
			...
			public void addInformation(ItemStack itemstack, World world, List<ITextComponent> list, ITooltipFlag flag) {
				...
				list.add(new StringTextComponent("\u00A75Refinement Level 2"));
			}
		...
		}.setRegistryName("magical_crystal_scythe_th"));
	}
