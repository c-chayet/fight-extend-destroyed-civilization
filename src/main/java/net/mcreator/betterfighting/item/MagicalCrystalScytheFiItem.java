...
public class MagicalCrystalScytheFiItem extends BetterFightingModElements.ModElement {
	@ObjectHolder("better_fighting:magical_crystal_scythe_fi")
	public static final Item block = null;

	public MagicalCrystalScytheFiItem(BetterFightingModElements instance) {
		super(instance, 49);
	}
	...
	public void initElements() {
		elements.items.add(() -> new ItemToolCustom() {
			...
			public void addInformation(ItemStack itemstack, World world, List<ITextComponent> list, ITooltipFlag flag) {
				...
				list.add(new StringTextComponent("\u00A75Refinement Level 4"));
			}
		...
		}.setRegistryName("magical_crystal_scythe_fi"));
	}
