...
public class WoodenKnifeItem extends BetterFightingModElements.ModElement {
	@ObjectHolder("better_fighting:wooden_knife")
	public static final Item block = null;
	public WoodenKnifeItem(BetterFightingModElements instance) {
		super(instance, 1);
	}
