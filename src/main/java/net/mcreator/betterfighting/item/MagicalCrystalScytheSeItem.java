...
public class MagicalCrystalScytheSeItem extends BetterFightingModElements.ModElement {
	@ObjectHolder("better_fighting:magical_crystal_scythe_se")
	public static final Item block = null;

	public MagicalCrystalScytheSeItem(BetterFightingModElements instance) {
		super(instance, 46);
	}
	...
	public void initElements() {
		elements.items.add(() -> new ItemToolCustom() {
			...
			public void addInformation(ItemStack itemstack, World world, List<ITextComponent> list, ITooltipFlag flag) {
				...
				list.add(new StringTextComponent("\u00A75Refinement Level 1"));
			}
		...
		}.setRegistryName("magical_crystal_scythe_se"));
	}
