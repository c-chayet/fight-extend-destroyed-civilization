...
public class StoneKnifeItem extends BetterFightingModElements.ModElement {
	@ObjectHolder("better_fighting:stone_knife")
	public static final Item block = null;
	public StoneKnifeItem(BetterFightingModElements instance) {
		super(instance, 2);
	}
