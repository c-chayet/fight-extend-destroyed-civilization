...
public class MagicalCrystalScytheeiItem extends BetterFightingModElements.ModElement {
	@ObjectHolder("better_fighting:magical_crystal_scytheei")
	public static final Item block = null;

	public MagicalCrystalScytheeiItem(BetterFightingModElements instance) {
		super(instance, 52);
	}
	...
	public void initElements() {
		elements.items.add(() -> new ItemToolCustom() {
			...
			public void addInformation(ItemStack itemstack, World world, List<ITextComponent> list, ITooltipFlag flag) {
				...
				list.add(new StringTextComponent("\u00A75Refinement Level 5[max] Core Condense II"));
			}
		...
		}.setRegistryName("magical_crystal_scytheei"));
	}
