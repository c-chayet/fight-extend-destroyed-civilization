...
public class NetheriteScytheItem extends BetterFightingModElements.ModElement {
	@ObjectHolder("better_fighting:netherite_scythe")
	public static final Item block = null;

	public NetheriteScytheItem(BetterFightingModElements instance) {
		super(instance, 44);
	}
